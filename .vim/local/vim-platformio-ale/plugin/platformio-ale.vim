" Source: https://gitlab.robitaille.host/marcel/dotfiles/blob/master/vim/plugin/ale-platformio.vim
...
let g:ale_cpp_gcc_options = s:pio_gcc_flags["gccDefaultCppFlags"] . ' -I' . join(s:imports, ' -I')
let g:ale_cpp_gcc_executable = s:pio_gcc_flags["execPath"]

let g:ale_linters = {
\   'cpp': ['ccls', 'cppcheck', 'cpplint', 'cquery', 'flawfinder', 'gcc'],
\}
